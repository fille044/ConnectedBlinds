...
int ModeState = 0;
int blueLed = 13; 		// D7 GPIO13
int greenLed = 12;  	// D6 GPIO12
int button = 16;      // D0 GPIO16
int photoTransitor = A0;
...
void controlServo(int Status)
{
  ...
  if(Status == 2 && lightLevel > 500 && closeDone == FALSE) {
    myservo.attach(14);
  ...
  if(Status == 2 && lightLevel < 450 && openDone == FALSE) {
    myservo.attach(14);
...
void loop()
{
  //lightLevel = analogRead(photoTransitor);
